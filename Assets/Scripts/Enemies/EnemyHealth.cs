...
public class EnemyHealth : EntityHealth
{
    ...
    {
        bool wasHit = base.TakeDamage(damage, elementalDamage, elementType, damageDealer); // |EN| Call base method to apply damage |TR| Hasarı uygulamak için temel yöntemi çağır
